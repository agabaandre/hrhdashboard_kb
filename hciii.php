...
$sql11= "SELECT COUNT(DISTINCT(facility_name)) AS units,SUM(male) AS male,SUM(female) AS female,n.facility_type_name,n.district_name,SUM(approved) AS approved,SUM(total) AS filled  FROM national_jobs n WHERE n.facility_type_name='HCIII'";
...
$sql11= "SELECT COUNT(DISTINCT(facility_name)) AS units,SUM(male) AS male,SUM(female) AS female,n.facility_type_name,n.district_name,SUM(approved) AS approved,SUM(total) AS filled  FROM national_jobs n WHERE  n.facility_type_name='HCIII'  GROUP BY n.district_name ORDER BY n.district_name";
