...
<div class="wrapper">
 ...
 <?php include'Header.php';
    ...
    $sql11= "SELECT SUM(male) AS male,SUM(female) AS female,district_name,SUM(approved) AS approved,SUM(total) AS filled  FROM national_jobs n";
    ...
    <section class="content">
		...
		<?php		
			 ...
			 if(isset($_POST['Limit'])){
				...
				$nonEmpty[7]="n.region_name";
				  ...
				  $count =1;
            		...
            		$display = $district_name.' '.$institution_type.' '.$facility_name.' '.$facility_type_name.' '.$ownership.' '.$job_category.' '.$job_classification.' '.$region_name." District Summary ";
			...
			//echo $sql11;
                ...
                $sql11= "SELECT SUM(male) AS male,SUM(female) AS female,district_name,SUM(approved) AS approved,SUM(total) AS filled FROM national_jobs  GROUP BY district_name ORDER BY district_name";
    
    
    
                $display = 'National District Summary';
