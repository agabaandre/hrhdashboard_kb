...
<div class="wrapper">
 ...
 <?php include'Header.php';
    ...
    include('connect.php'); 
     ...
     $sqld =  "SELECT DISTINCT(district_name) AS district_name  FROM national_jobs n ORDER BY district_name";
      ...
      <?php include("menu2.php"); ?>
			...
			<?php		
			 ...
			 if(isset($_POST['Limit'])){
                 ...
                 $sqld =  "SELECT DISTINCT(district_name) AS district_name  FROM national_jobs  ORDER BY district_name";
		...
		$sql11= "SELECT SUM(male) AS male,SUM(female) AS female,job_name,district_name,institution_type,facility_type_name,salary_scale,SUM(approved) AS approved,SUM(total) AS filled  FROM national_jobs n WHERE district_name='$district' ";
				...
				$nonEmpty[7]="n.region_name";
				  ...
				  $count =1;
            		...
            		$display = $district_name.' '.$institution_type.' '.$ownership.' '.$job_category.' '.$job_classification.' '.$region_name;         
			

		
			$sql11=$sql11." GROUP BY job_id,district_name ORDER BY salary_scale,job_name";
