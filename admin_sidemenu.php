       ...
       <li>
        ...
        <li>
          <a href="attendancesummary.php">
            <i class="fa fa-user-md"></i>Staffing &amp; Attendance
          </a>
        </li>
           <li>
          <a href="national_job_summary.php">
            <i class="fa fa-dashboard"></i>Audit Reports
          </a>
        </li>
          
          <li class="treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Reg & Licensure Repts</span>
        ...
        <li>
          ...
          <a href="#">
            ...
            <span>Professional Councils</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
