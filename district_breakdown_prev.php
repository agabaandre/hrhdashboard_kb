...
<div class="wrapper">
 ...
 <?php include'Header.php';
    ...
    $sql11= "SELECT district_name,facility_name,facility_type_name,SUM(approved) AS approved,SUM(total) AS filled  FROM quarterly_national_jobs n ";
 ...
 <?php include'admin_sidemenu.php';?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
			 ...
			 if(isset($_POST['Limit'])){
				...
				$nonEmpty[7]="n.region_name";
				  ...
				  $count =1;
            		...
            		$display = $month.'  '.$year.'  '.$district_name.' '.$institution_type.' '.$facility_name.' '.$facility_type_name.' '.$ownership.' '.$job_category.' '.$job_classification.' '.$region_name. " District Breakdown";
			 
			
			$sql11=$sql11." AND month='".$month."' AND year=$year GROUP BY district_name,facility_name,facility_type_name ORDER BY district_name,facility_name,facility_type_name";
		...
		$sql11= "SELECT district_name,facility_name,facility_type_name,SUM(approved) AS approved,SUM(total) AS filled  FROM quarterly_national_jobs  ";

             

		$sql11=$sql11." WHERE month='".$month."' AND year=$year GROUP BY district_name,facility_name,facility_type_name ORDER BY district_name,facility_name,facility_type_name";
              

               		 $display = $month.'  '.$year.'  '." National District Breakdown";
		       }
		  ...
		  <th>% Vacant in Position</th>
			...
			$sql12= "SELECT SUM(total) AS filled_structure,SUM(male) AS male_structure,SUM(female) AS female_structure  FROM national_jobs n  WHERE district_name='$district_name' AND facility_name='$facility_name' AND facility_type_name='$facility_type_name' AND approved > 0";
			

			$sql13= "SELECT SUM(total) AS filled_not_on_structure  FROM national_jobs n  WHERE district_name='$district_name' AND facility_name='$facility_name' AND facility_type_name='$facility_type_name' AND approved = 0";
