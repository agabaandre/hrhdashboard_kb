...
<div class="wrapper">
 ...
 $sql11= "SELECT COUNT(DISTINCT(facility_name)) AS units,SUM(male) AS male,SUM(female) AS female,n.facility_type_name,n.district_name,SUM(approved) AS approved,SUM(total) AS filled  FROM national_jobs n WHERE  n.facility_type_name='City Health Office'";
      ...
      <div class="box">
		...
		<?php		
			...
			$sql11=$sql11." GROUP BY n.district_name ORDER BY n.district_name";
            		...
            		$display = $district_name.' '.$institution_type.' '.$facility_name.' '.$facility_type_name.' '.$ownership.' '.$job_category.' '.$job_classification.' '.$region_name." City Health Office"; 
                       ...
                       $sql11= "SELECT COUNT(DISTINCT(facility_name)) AS units,SUM(male) AS male,SUM(female) AS female,n.facility_type_name,n.district_name,SUM(approved) AS approved,SUM(total) AS filled  FROM national_jobs n WHERE  n.facility_type_name='City Health Office'  GROUP BY n.district_name ORDER BY n.district_name";  
