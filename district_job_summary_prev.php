...
<div class="wrapper">
 ...
 <?php include'Header.php';
    ...
    include('connect.php'); 
     ...
     $sqld =  "SELECT DISTINCT(district_name) AS district_name  FROM quarterly_national_jobs n";
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <?php include("menu5.php"); ?>
		  ...
		  <tr>
			...
			<?php		
			 ...
			 if(isset($_POST['Limit'])){
                 ...
                 $sqld =  "SELECT DISTINCT(district_name) AS district_name  FROM quarterly_national_jobs  ORDER BY district_name";
               

              
                $display = "District Job Summary";
		       }
		...
		$resultsd=mysqli_query($mysqli,$sqld);
		...
		$district = $rowd['district_name'];

		$sql11= "SELECT job_name,district_name,institution_type,facility_type_name,salary_scale,SUM(approved) AS approved,SUM(total) AS filled  FROM quarterly_national_jobs n WHERE district_name='$district' ";
				...
				$nonEmpty[2]="n.facility_type_name";
				}
				...
				$nonEmpty[7]="n.region_name";
				  ...
				  $count =1;
            		...
            		$display = $month.'  '.$year.'  '.$district_name.' '.$institution_type.' '.$ownership.' '.$job_category.' '.$job_classification.' '.$region_name;         
			

		
			$sql11=$sql11." AND month='".$month."' AND year=$year GROUP BY job_id,district_name ORDER BY salary_scale,job_name";

		
		echo $sql11;	
?>
 <table class="table table-striped table-bordered table-hover multiple-select-row data-table-	export wrap"  id="example2" data-show-export="true">
							
<thead>
	        <tr><h2><?php  echo $district.' District'; ?></h2></tr>
...
while ($row=mysqli_fetch_assoc($results)) {
		...
		$job_name = $row['job_name'];
			...
			$sql12= "SELECT SUM(total) AS filled_structure,SUM(male) AS male_structure,SUM(female) AS female_structure  FROM national_jobs n  WHERE job_name='$job_name' AND district_name='$district' AND approved > 0";
			

			$sql13= "SELECT SUM(total) AS filled_not_on_structure  FROM national_jobs n  WHERE job_name='$job_name' AND district_name='$district' AND approved = 0";
