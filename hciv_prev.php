...
$sql11= "SELECT COUNT(DISTINCT(facility_name)) AS units,n.facility_type_name,n.district_name,SUM(approved) AS approved,SUM(total) AS filled  FROM quarterly_national_jobs n WHERE n.facility_type_name='HCIV'";
      ...
      <div class="box">
		...
		<?php		
			...
			$sql11=$sql11." AND month='".$month."' AND year=$year GROUP BY n.district_name ORDER BY n.district_name";
            		...
            		$display = $month.'  '.$year.'  '.$district_name.' '.$institution_type.' '.$facility_name.' '.$facility_type_name.' '.$ownership.' '.$job_category.' '.$job_classification.' '.$region_name." HCIVs"; 
