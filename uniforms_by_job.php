      ...
      <div class="box">
            ...
            <div class="box-body">
              <div class="table-responsive">
				...
				$nonEmpty[2]="Job";
		  		...
		  		if($noOfElements>0){
                        ...
                        $display = "Uniforms by Job Category : Results Limited By ".$District." ".$Facility." ".$Job."";
                    ...
                    $sql11=$sql11." GROUP BY Job ORDER BY Job";
                   ...
                   // echo $sql11;       
                    ...
                    $_SESSION['query']=$sql11;
                       ...
                       // $sql11= "SELECT District,Facility,Job,Gender,UniformSize,COUNT(PersonId) AS no FROM uniforms GROUP BY Job,Gender,UniformSize,District,Facility ORDER BY District,Facility,Job,Gender,UniformSize";
                        ...
                        $sql11 =  "SELECT Job,SUM(S) AS S,SUM(M) AS M,SUM(L) AS L,SUM(XL) AS XL,SUM(XXL) AS XXL FROM temp_uniforms_final GROUP BY Job ORDER BY Job";
                        ...
                        $_SESSION['query']=$sql11;
                         ...
                         $display = "Uniforms by Job Category";
			  ...
			  */
                  ...
                  <tr><td>Total</td><td></td><td><?php echo $sum_s; ?></td><td><?php echo $sum_m; ?></td><td><?php echo $sum_l;?></td><td><?php echo $sum_xl; ?></td><td><?php echo $sum_xxl; ?></td><td><?php echo $sum_total; ?></td></tr> 
                <tfoot>
