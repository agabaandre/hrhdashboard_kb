...
$sql14= "SELECT DISTINCT(n.facility_name),SUM(male) AS male,SUM(female) AS female,SUM(approved) AS approved,SUM(total) AS filled  FROM national_jobs n WHERE facility_type_name IN ('Regional Referral Hospital','Ministry','Specialised National Facility','National Referral Hospital')  ";                         
    
    $display = 'Central Institutions';
      ...
      <div class="box">
		...
		<?php		
			...
			$sql14=$sql14." GROUP BY n.facility_name ORDER BY n.facility_name";
            		...
            		$display = $district_name.' '.$institution_type.' '.$facility_name.' '.$facility_type_name.' '.$ownership.' '.$job_category.' '.$job_classification.' '.$region_name." Central Institutions";  
		  ...
		  <th> % Female </th>
			...
			$sum_unit_norms = 0;
                                  ...
                                  $num = mysqli_num_rows($results14);
                                      ...
                                      while ($row=mysqli_fetch_assoc($results14)) {
