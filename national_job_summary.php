...
<div class="wrapper">
 ...
 <?php include'Header.php';
   ...
   $sql11 = "SELECT SUM(male) AS male,SUM(female) AS female,facility_type_name,SUM(approved) AS approved,SUM(total) AS filled,job_name,salary_scale  FROM national_jobs n";
      ...
      <?php include("menu2.php"); ?>
		...
		<?php		
			...
			$sql11=$sql11." GROUP BY job_id ORDER BY salary_scale,job_name";
            		...
            		$display = $district_name.' '.$institution_type.' '.$facility_name.' '.$facility_type_name.' '.$ownership.' '.$job_category.' '.$job_classification.' '.$region_name." Job Summary";         
				...
				$sql11 = "SELECT SUM(male) AS male,SUM(female) AS female,facility_type_name,SUM(approved) AS approved,SUM(total) AS filled,job_name,salary_scale  FROM national_jobs  GROUP BY job_id ORDER BY salary_scale,job_name";
