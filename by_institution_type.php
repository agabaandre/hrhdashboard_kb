...
<div class="wrapper">
 ...
 <?php include'Header.php';
    ...
    $sql11= "SELECT SUM(male) AS male,SUM(female) AS female,institution_type,SUM(approved) AS approved,SUM(total) AS filled FROM national_jobs n";
    ...
    <section class="content">
      <?php include("menu2.php"); ?>
		...
		<?php		
			...
			$sql11=$sql11." GROUP BY institution_type ORDER BY institution_type";
                         
            		$display = $district_name.' '.$institution_type.' '.$facility_name.' '.$facility_type_name.' '.$ownership.' '.$job_category.' '.$job_classification.' '.$region_name." Institution Type";         
            ...
            //echo $sql11;
				...
				$sql11= "SELECT SUM(male) AS male,SUM(female) AS female,institution_type,SUM(approved) AS approved,SUM(total) AS filled FROM national_jobs  GROUP BY institution_type ORDER BY institution_type";

               $_SESSION['query']=$sql11;
			  
                $display = " By Institution Type";
		       }
