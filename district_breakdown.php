...
<div class="wrapper">
 ...
 <?php include'Header.php';
    ...
    $sql11= "SELECT SUM(male) AS male,SUM(female) AS female,district_name,facility_name,facility_type_name,SUM(approved) AS approved,SUM(total) AS filled  FROM national_jobs n ";
			 ...
			 if(isset($_POST['Limit'])){
				...
				$nonEmpty[7]="n.region_name";
				  ...
				  $count =1;
            		...
            		$display = $district_name.' '.$institution_type.' '.$facility_name.' '.$facility_type_name.' '.$ownership.' '.$job_category.' '.$job_classification.' '.$region_name. " District Breakdown";
			 
			
			$sql11=$sql11." GROUP BY district_name,facility_name,facility_type_name ORDER BY district_name,facility_name,facility_type_name";
				 ...
				 $sql11= "SELECT SUM(male) AS male,SUM(female) AS female,district_name,facility_name,facility_type_name,SUM(approved) AS approved,SUM(total) AS filled  FROM national_jobs  GROUP BY district_name,facility_name,facility_type_name ORDER BY district_name,facility_name,facility_type_name";

             
                         
                         $display = "National District Breakdown";
		       }
